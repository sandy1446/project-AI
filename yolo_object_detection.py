...
# Loading image
img = cv2.imread("D:\Recovered data 09-13 12_11_38\Deep Scan result\Special Lost Files(Lab)\Camera\APPLE\iPhone 5s2741.jpg", cv2.IMREAD_UNCHANGED)
scale_percent=20
...
cv2.line(img,(0,int(height)),(int(width),int(height/2)),(0,255,0),1)
